...
export class Config {
  ...
  'server.port' = '8081';
  'jhipster.clientApp.name' = 'lummyCode';
  ...
  'jhipster.mail.from' = 'lummyCode@localhost';
  'jhipster.swagger.default-include-pattern' = '/api/.*';
  'jhipster.swagger.title' = 'lummyCode API';
  'jhipster.swagger.description' = 'lummyCode API documentation';
  ...
  'eureka.instance.appname' = 'lummyCode';
  'eureka.instance.instanceId' = 'lummyCode:${random.value}';
